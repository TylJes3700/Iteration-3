      ...
      return 
         new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
               ...
               // Create order
                  Order order = new Order(id, Store.getCheckoutController().getTotal(), Store.getCheckoutController().getTax(), GUI.getDate(), GUI.getTime(), payType, Store.dataAdapter.getName(), Store.getCheckoutController().getProducts());
