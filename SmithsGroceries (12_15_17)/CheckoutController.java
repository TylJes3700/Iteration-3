            ...
            public void handle(ActionEvent event) {
               ...
               if (message.equals("")) {
                  if (product.getUnit().equals("Single")) {
                     ...
                     tax += product.getPrice()*product.getTax()/100;
                  }
                  else {
                     ...
                     tax += product.getPrice()*product.getTax()/100*product.getQuantity();
                  }
                  if (available - product.getQuantity() < 0) {
                     ...
                     tax -= (product.getUnit().equals("Single")) ? product.getPrice()*product.getTax()/100 : product.getPrice()*product.getTax()/100*product.getQuantity();
...
// METHODS
   ...
   public double getTax() {
      return Double.valueOf(GUI.formatter2.format(tax));
   }
